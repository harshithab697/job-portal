class JobsController < ApplicationController
  before_action :check_recruiter, only: [:new, :edit, :create, :update, :destroy]
  ...
  private
    #checks wheather the current user is a recruiter
    def check_recruiter
      unless current_recruiter
        redirect_to dashboard_root_path, notice: 'You are not authorized'
      end
    end
